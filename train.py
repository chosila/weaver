...
def train_load(args):
    ...
    train_loader = DataLoader(train_data, batch_size=args.batch_size, drop_last=False, pin_memory=True,
                              num_workers=min(args.num_workers, int(len(train_files) * args.file_fraction)),
                              persistent_workers=args.num_workers > 0 and args.steps_per_epoch is not None)
    val_loader = DataLoader(val_data, batch_size=args.batch_size, drop_last=False, pin_memory=True,
